    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <br />
                {
                    doneStatus ? <DoneFrame doneStatus={doneStatus} resetGame={this.resetGame} /> : <Number selectedNumbers={selectedNumbers} selectNumber={this.selectNumber} usedNumbers={usedNumbers} />
                }
            </div>
        )
    }
